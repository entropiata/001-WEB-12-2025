    ...
    <div className="bg-gray-50">
      ...
      <section className="bg-emerald-700 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl mb-4">Pelayanan Kami</h1>
            ...
            {pelayananPoli.map((layanan, index) => {
              ...
              return (
                ...
                >
                  <Card
                    id={layanan.id}
                    className="hover:shadow-lg transition-all hover:scale-[1.02] border-emerald-100 scroll-mt-20 h-full cursor-pointer"
                  >
